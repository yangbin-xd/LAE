...
# print('UNet nmse:', np.round(UNet_nmse1[v,:], 4))
...
UNet_nmse1 = np.array([0.0389, 0.0262, 0.0217, 0.0171, 0.0147, 0.0134, 0.0124])
...
plt.legend(fontsize=font2, ncol=2)
...
UNet_nmse1 = np.array([0.0708, 0.0561, 0.0444, 0.039,  0.0353, 0.0334, 0.0346])
...
UNet_nmse1 = np.array([0.1155, 0.1015, 0.0884, 0.0848, 0.0797, 0.0804, 0.0813])
